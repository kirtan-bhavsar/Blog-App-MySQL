...
return (
  <div className='home'>
    ...
    <div className="paginationContainer">
     {currentPage !== 1 && <Link to={cat ? `/?cat=${cat}&page=${Number(currentPage)-1}` : `/?page=${Number(currentPage)-1}`}><FaChevronLeft className='paginationBtn'></FaChevronLeft></Link>}
     {paginationArray.map((pageNum) => {
       return(
           <div className="paginationBtn">
             ...
             {/* <Link><button className={pageNum === Number(currentPage) ? 'active' : ''}>{pageNum}</button></Link> */}
           </div>
       )
      })}
